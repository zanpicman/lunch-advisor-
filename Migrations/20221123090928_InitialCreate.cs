        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DishRating_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DishRating_Dish_DishID",
                        column: x => x.DishID,
                        principalTable: "Dish",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WaiterRating", x => x.ID);
                    table.ForeignKey(
                        name: "FK_WaiterRating_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WaiterRating_Waiter_WaiterID",
                        column: x => x.WaiterID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DishRating_DishID",
                table: "DishRating",
                column: "DishID");

            migrationBuilder.CreateIndex(
                name: "IX_DishRating_UserID",
                table: "DishRating",
                column: "UserID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WaiterRating_UserID",
                table: "WaiterRating",
                column: "UserID");

            migrationBuilder.CreateIndex(
                name: "IX_WaiterRating_WaiterID",
                table: "WaiterRating",
                column: "WaiterID");
        }
